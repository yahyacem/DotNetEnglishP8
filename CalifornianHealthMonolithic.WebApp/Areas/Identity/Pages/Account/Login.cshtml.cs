...
namespace CalifornianHealthMonolithic.WebApp.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<Patient> signInManager, UserManager<Patient> userManager, ILogger<LoginModel> logger, IAuthenticationService authenticationService)
        {
